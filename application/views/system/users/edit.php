		...
		<section class="col-lg-9">
			...
			<form class="form-admin" method="post" action="#" id="form-edit-user" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="checkbox col-lg-3">
						<label>
							<input type="checkbox" name="modules[]" value="articles" <?php foreach($adm_user->adm_modulos as $modulo){if($modulo->mad_nombre=='articles'){echo 'checked';}} ?>/> Publicar Artículos
						</label>
					</div>
					<div class="checkbox col-lg-3">
						<label>
