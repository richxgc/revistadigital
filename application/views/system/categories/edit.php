		...
		<section class="col-lg-9">
			...
			<form class="form" method="post" action="#" id="form-edit-category">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Nombre de la categoría" name="cat_nombre" value="<?php echo $category->cat_nombre; ?>" pattern="^[\w\W\s\-\_]{5,}$" required/>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="nombre-de-categoria" name="cat_url" value="<?php echo $category->cat_url; ?>" pattern="^[a-z0-9\-]{5,}$" required/>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="#0099FF" name="cat_color" id="cat_color" value="<?php echo $category->cat_color; ?>" pattern="^#[a-fA-Z0-9]{6}$" required/>
				...
				<div class="form-group">
					...
					<select class="form-control" name="cat_super_id">
						...
						<option value="<?php echo $cat->cat_id; ?>" <?php if($category->cat_super_id == $cat->cat_id){echo 'selected="selected"';} ?>><?php echo $cat->cat_nombre; ?></option>
						<?php endforeach; ?>
					</select>
				...
				<div class="form-group">
					<button type="submit" class="btn btn-success" id="btn-submit"><i class="fa fa-upload"></i> Guardar categoría</button>
